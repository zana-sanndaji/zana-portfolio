    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 flex items-center justify-center px-4">
        ...
        >
          ...
          <div className="absolute top-20 right-0 w-80 h-80 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl opacity-60 animation-delay-2000" />
        ...
        >
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-3 px-8 py-4 bg-white text-indigo-600 rounded-full font-bold text-lg shadow-2xl"
            >
